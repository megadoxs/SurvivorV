...
public class KeyRebind : MonoBehaviour
{
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            //TODO if escape is pressed set to null, if key is already bind highlight in red both keyBinds
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<KeyRebind>();
        ...
        [SerializeField] private bool m_OverrideActionName;

        private InputActionRebindingExtensions.RebindingOperation m_RebindOperation;

        private static List<KeyRebind> s_RebindActionUIs;
        ...
        {
            if (m_ActionLabel != null && !m_OverrideActionName)
            {
                var action = m_Action?.action;
